...
df_infra_combined = pd.read_excel(app_dir / "최종_숙소_식당_카페_주차장.xlsx")
df_stats = pd.read_excel(app_dir / "최종_숙소_식당_카페_주차장(축제명)_분리.xlsx")
df_infra_merged = pd.read_excel(app_dir / "최종_숙소_식당_카페_주차장(축제명).xlsx")